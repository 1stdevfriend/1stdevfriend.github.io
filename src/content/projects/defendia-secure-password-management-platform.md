...
featured: true
order: 1
notes: "Strong DevOps/security signal: CI/CD, code signing/notarization, zero-knowledge architecture, Supabase edge functions. Older duplicate repo 'koders/Defendia' folded in (no separate role given)."
---
