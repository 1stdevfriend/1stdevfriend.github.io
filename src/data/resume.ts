export const profile = {
  ...
  location: "Dehradun, India (open to relocation — Germany & Luxembourg)",
  relocation:
    "Open to relocating to Germany or Luxembourg for the right role. Also available for remote work.",
  ...
  summary:
    "Senior DevOps & Platform Engineer with 6+ years building and running high-availability infrastructure on AWS, Kubernetes, and Hetzner bare metal. I replace fragile, manual deployments with automated, observable systems — Infrastructure as Code, CI/CD, and production-grade monitoring — for enterprise, startup, and government clients.",
  tagline:
    "Senior DevOps & Platform Engineer (SRE) with 6+ years automating AWS, Kubernetes, and CI/CD infrastructure for enterprise, startup, and government clients. Open to DevOps/SRE roles in Germany & Luxembourg.",
};
...
export const keyProjects = [
  {
    name: "Instaride",
    description:
      "Germany Government Mobility Platform using AWS, Flask, PostgreSQL/PostGIS and automated Flutter deployments.",
  },
  {
    name: "Defendia",
    description:
      "CI/CD for browser extensions, Electron, React and Postfix mail infrastructure.",
  },
  {
    name: "Wrencho",
    description:
      "AWS infrastructure, Docker, monitoring, Strapi CMS and mobile release pipelines.",
  },
  {
    name: "RFID Attendance System (Indian Army)",
    description:
      "Secure isolated deployment of hardware-integrated Flask backend.",
  },
];
